...
class StudentManagementApp:
    def __init__(self, root):
        ...
        self.label = tk.Label(root, text="Do you want to add a student?")
        ...
        self.btn_yes = tk.Button(root, text="Yes", width=10, command=self.open_student_form)
        ...
        self.btn_no = tk.Button(root, text="No", width=10, command=self.quit_program)
    ...
    def open_student_form(self):
        ...
        tk.Label(self.form, text="Student Name:").grid(row=0, column=0, padx=10, pady=10, sticky="e")
        ...
        tk.Label(self.form, text="Student ID:").grid(row=1, column=0, padx=10, pady=10, sticky="e")
        ...
        tk.Label(self.form, text="Course Name:").grid(row=2, column=0, padx=10, pady=10, sticky="e")
        ...
        tk.Label(self.form, text="Marks:").grid(row=3, column=0, padx=10, pady=10, sticky="e")
        ...
        tk.Button(self.form, text="Submit", command=self.submit_student).grid(row=4, column=0, columnspan=2, pady=20)

        # Create a button labeled "Show All Students" that calls show_all_students when clicked.
        tk.Button(self.form, text="Show All Students", command=self.show_all_students).grid(row=5, column=0, columnspan=2, pady=10)
    ...
    def open_student_info_window(self, student):
        ...
        tk.Label(self.info_window, text=f"Name: {student.name}").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        tk.Label(self.info_window, text=f"Student ID: {student.student_id}").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        ...
        tk.Label(self.info_window, text="Add/Update Course:").grid(row=3, column=0, padx=10, pady=5, sticky="w")

        # Input field for new course name
        tk.Label(self.info_window, text="Course Name:").grid(row=4, column=0, padx=10, pady=5, sticky="e")
        ...
        tk.Label(self.info_window, text="Marks:").grid(row=5, column=0, padx=10, pady=5, sticky="e")
